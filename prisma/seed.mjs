...
const seedProjects = [
  ...
  },
  {
    ...
    gallery: [industrialImages.logisticsAerial, industrialImages.crane, industrialImages.site],
...
async function seedPostsTable(authorId) {
  for (const post of seedPosts) {
    const { id, data } = splitId(post);
