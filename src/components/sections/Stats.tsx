...
const stats = [
  ...
  { icon: Building2, number: <CountUp end={360} prefix="INR " suffix="Cr+" />, label: "Profiled value", descriptor: "Visible project portfolio and large development participation" },
